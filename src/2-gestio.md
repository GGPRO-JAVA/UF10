...
- M:\Documents\Unitat10\apartat1 (ruta a una carpeta)
- N:\Documents\Unitat10\apartat1\Activitats.txt (ruta a un arxiu)
...
- /Documents/Unitat10/apartat1 (ruta a una carpeta)
- /Documents/Unitat10/apartat1/Activitats.txt (ruta a un arxiu)
...
**Quan un programa s'executa**, per defecte **se li assigna una carpeta de treball**. Aquesta carpeta **sol ser la carpeta des d'on es llança el programa**. En el cas d'un programa executat a través d'un IDE, la carpeta de treball sol ser la mateixa on s'han guardat els arxius del projecte.
...
- Viatges
- Unitat10/apartat1
- Unitat10/apartat1/Activitats.txt
...
```java
File f = new File("Unitat10/apartat1/Activitats.txt");
```
...
--- | ---  
C:/Projectes/Java | C:/Projectes/Java/Unitat10/apartat1/Activitats.txt
X:/Unitats | X:/Unitats/Unitat10/apartat1/Activitats.txt
/Programes | /Programes/Unitat10/apartat1/Activitats.txt
...
Donada aquesta ruta relativa, n'hi ha prou amb garantir que el fitxer `Activitats.txt` estiga sempre en el mateix directori de treball de l'aplicació, qualsevol que siga aquest, i independentment del sistema operatiu utilitzat (en un ordinador pot ser `C:\Programes` i en un altre `/Documents`). En qualsevol d'aquests casos, la ruta sempre serà correcta.  
...
## 2.3. Mètodes de la classe File (Java)
